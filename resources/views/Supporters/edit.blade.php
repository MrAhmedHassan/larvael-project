    ...
    <div class='container mt-5'>
        ...
        <form method='post' action='/supporters/{{$supporter->id}}' enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" value="{{$supporter->name}}" id="exampleFormControlInput1" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" class="form-control" value="{{$supporter->email}}" id="exampleFormControlInput3" required>
            </div>

            <div class="form-group">
                <label for="exampleFormControlInput4" class='font-weight-bold'>National_id</label>
                <input type="text" name="national_id" class="form-control" value="{{$supporter->national_id}}" id="exampleFormControlInput4" required>
            </div>

            <div class="form-group">
                <label for="exampleFormControlInput5" class='font-weight-bold'>Avatar</label>
                <input type="file" name="avatar" class="form-control" value="{{$supporter->avatar}}" id="exampleFormControlInput5" >
            </div>
