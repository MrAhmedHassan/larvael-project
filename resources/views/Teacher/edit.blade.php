...
<form method='post' action='/Teacher/{{$post->id}}'>
{{method_field('PUT')}}
@csrf

<div class="form-group">
    <label for="exampleFormControlInput1" class='font-weight-bold'>Name</label>
    <input type="text" name="name" class="form-control" value="{{$post->name}}" id="exampleFormControlInput1" >
  </div>
  ...
  <div class="form-group">
    ...
    <input type="email" name="email" class="form-control" value="{{$post->email}}" id="exampleFormControlInput3" >
  </div>

  <div class="form-group">
    <label for="exampleFormControlInput4" class='font-weight-bold'>National_id</label>
    <input type="text" name="national_id" class="form-control" value="{{$post->national_id}}" id="exampleFormControlInput4" >
  </div>

  <div class="form-group">
    <label for="exampleFormControlInput5" class='font-weight-bold'>Avatar</label>
    <input type="text" name="avatar" class="form-control" value="{{$post->avatar}}" id="exampleFormControlInput5" >
  </div>
